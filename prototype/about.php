 ...
 * صفحه درباره هلدینگ سرمایه‌گذاری رهناب فارمد — معمار زنجیره ارزش زیست‌دارویی کشور
 */

$page_title  = 'درباره ما | هلدینگ سرمایه‌گذاری رهناب فارمد';
$page_desc   = 'معمار زنجیره ارزش زیست‌دارویی، پالایشگاه صنعتی پلاسما، سرمایه‌گذاری بر نخبگان بیوتکنولوژی و تولید فرآورده‌های با فناوری بالا در ایران.';
$is_home     = false;
$active_page = 'about';
  ...
  <section class="about-hero relative pt-32 sm:pt-40 pb-16 lg:pb-20 overflow-hidden border-b border-white/10">
    ...
    <div class="container mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
      ...
      <nav aria-label="Breadcrumb" class="flex items-center gap-2 text-xs text-slate-400 mb-8">
        <a href="index.php" class="hover:text-gold-400 transition-colors flex items-center gap-1.5 group">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div class="lg:col-span-6 relative">
          <div class="relative rounded-3xl overflow-hidden border border-gold-400/30 shadow-[0_20px_60px_rgba(0,0,0,0.8)] group">
            <img src="assets/images/about-cleanroom.jpg" alt="Cleanroom Facility"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div class="p-8 rounded-3xl bg-[#0A0E17]/85 border border-white/10 hover:border-gold-400/50 hover:bg-[#101522] transition-all duration-300 flex flex-col justify-between group shadow-xl hover:-translate-y-1.5">
          <div>
            ...
            <div class="w-16 h-16 rounded-2xl bg-gold-400/[0.04] border border-gold-400/25 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/60 group-hover:bg-gold-400/15 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.2)] transition-all duration-300">
              <img src="assets/icons/services/service-veterinary-vaccines.svg" alt="واکسن‌های دامی و طیور" class="w-10 h-10 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <div class="p-8 rounded-3xl bg-[#0A0E17]/85 border border-white/10 hover:border-gold-400/50 hover:bg-[#101522] transition-all duration-300 flex flex-col justify-between group shadow-xl hover:-translate-y-1.5">
          <div>
            ...
            <div class="w-16 h-16 rounded-2xl bg-gold-400/[0.04] border border-gold-400/25 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/60 group-hover:bg-gold-400/15 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.2)] transition-all duration-300">
              <img src="assets/icons/services/service-pediatric-pharma.svg" alt="داروهای کودکان و اطفال" class="w-10 h-10 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <div class="p-8 rounded-3xl bg-[#0A0E17]/85 border border-white/10 hover:border-gold-400/50 hover:bg-[#101522] transition-all duration-300 flex flex-col justify-between group shadow-xl hover:-translate-y-1.5">
          <div>
            ...
            <div class="w-16 h-16 rounded-2xl bg-gold-400/[0.04] border border-gold-400/25 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/60 group-hover:bg-gold-400/15 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.2)] transition-all duration-300">
              <img src="assets/icons/services/service-nutraceuticals.svg" alt="مکمل‌های غذایی و درمانی" class="w-10 h-10 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <div class="p-8 rounded-3xl bg-[#0A0E17]/85 border border-white/10 hover:border-gold-400/50 hover:bg-[#101522] transition-all duration-300 flex flex-col justify-between group shadow-xl hover:-translate-y-1.5">
          <div>
            ...
            <div class="w-16 h-16 rounded-2xl bg-gold-400/[0.04] border border-gold-400/25 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/60 group-hover:bg-gold-400/15 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.2)] transition-all duration-300">
              <img src="assets/icons/services/service-biological-dressings.svg" alt="ارائه انواع پانسمان‌های زیستی و سوختگی" class="w-10 h-10 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <div class="p-8 rounded-3xl bg-[#0A0E17]/85 border border-white/10 hover:border-gold-400/50 hover:bg-[#101522] transition-all duration-300 flex flex-col justify-between group shadow-xl hover:-translate-y-1.5">
          <div>
            ...
            <div class="w-16 h-16 rounded-2xl bg-gold-400/[0.04] border border-gold-400/25 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/60 group-hover:bg-gold-400/15 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.2)] transition-all duration-300">
              <img src="assets/icons/services/service-plasma-therapy.svg" alt="ارائه انواع داروهای مشتق از پلاسما و نوترکیب" class="w-10 h-10 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <div class="p-8 rounded-3xl bg-[#0A0E17]/85 border border-white/10 hover:border-gold-400/50 hover:bg-[#101522] transition-all duration-300 flex flex-col justify-between group shadow-xl hover:-translate-y-1.5">
          <div>
            ...
            <div class="w-16 h-16 rounded-2xl bg-gold-400/[0.04] border border-gold-400/25 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/60 group-hover:bg-gold-400/15 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.2)] transition-all duration-300">
              <img src="assets/icons/services/service-vaccine-adjuvants.svg" alt="ارائه انواع یاورها و فرمولاسیون‌های اختصاصی واکسن" class="w-10 h-10 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
      ...
      <div class="pt-12 border-t border-white/10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <a href="https://nojinepharmed.com/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              <div class="h-16 flex items-center justify-center p-2 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                <img src="assets/images/subsidiaries/nojin_logo.webp" alt="Nozhin Zist"
          ...
          <a href="https://tpnojine.com/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              <div class="h-16 flex items-center justify-center p-2 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                <img src="assets/images/subsidiaries/logo-tamin-plasma.svg" alt="Tamin Plasma"
                  class="subsidiary-mono-logo h-10 w-auto object-contain">
              </div>
          ...
          <a href="https://demo-branding.com/persis/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              <div class="h-16 flex items-center justify-center p-2 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                <img src="assets/images/subsidiaries/logo-persisgen.png" alt="Persis Gene"
                  class="subsidiary-mono-logo h-10 w-auto object-contain">
              </div>
          ...
          <a href="http://arcbioassay.com/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              <div class="h-16 flex items-center justify-center p-2 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                <img src="assets/images/subsidiaries/logo-arc.png" alt="Arc Zist Azma"
                  class="subsidiary-mono-logo h-10 w-auto object-contain">
              </div>
          ...
          <a href="https://padraserum.com/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              <div class="h-16 flex items-center justify-center p-2 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                <img src="assets/images/subsidiaries/padra-serum-logo-who-Final-PNG-1.png" alt="Padra Serum"
                  class="subsidiary-mono-logo h-10 w-auto object-contain">
              </div>
          ...
          <a href="http://karayakhteh.ir/" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              <div class="h-16 flex items-center justify-center p-2 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                <img src="assets/images/subsidiaries/logo-karayakhte.webp" alt="KarayaKhteh"
                  class="subsidiary-mono-logo h-10 w-auto object-contain">
              </div>
    ...
    <div class="container mx-auto px-6 sm:px-10 lg:px-16">
      <div class="rounded-3xl p-8 sm:p-12 bg-gradient-to-r from-[#101522] via-[#0A0E17] to-[#05070B] border border-gold-400/30 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-2xl">
        ...
        <div class="shrink-0 flex items-center gap-4">
          <button class="btn-open-inquiry btn-primary text-sm px-7 py-3.5 rounded-full font-bold inline-flex items-center gap-2 cursor-pointer">
