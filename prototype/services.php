<?php
/**
 * Services & Capabilities Page Template
 * صفحه جامع خدمات، خطوط تولید و توانمندی‌های زیست‌دارویی هلدینگ رهناب فارمد
 */

$page_title  = 'خدمات و توانمندی‌ها | هلدینگ سرمایه‌گذاری رهناب فارمد';
$page_desc   = 'زنجیره جامع خدمات و توانمندی‌های زیست‌دارویی هلدینگ رهناب فارمد: واکسن‌های نوترکیب، داروهای اطفال، مکمل‌های درمانی، پانسمان‌های زیستی، مشتقات پلاسما و یاورهای واکسن.';
$is_home     = false;
      ...
      <div id="servicesGrid" class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
        ...
        <article class="service-showcase-card group">
          ...
          <div>
            ...
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gold-400/[0.04] border border-gold-400/20 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/50 group-hover:bg-gold-400/10 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.18)] transition-all duration-300">
              <img src="assets/icons/services/service-veterinary-vaccines.svg" alt="واکسن‌های دامی و طیور" class="w-10 h-10 sm:w-12 sm:h-12 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <article class="service-showcase-card group">
          ...
          <div>
            ...
            <!-- Icon Frame -->
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gold-400/[0.04] border border-gold-400/20 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/50 group-hover:bg-gold-400/10 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.18)] transition-all duration-300">
              <img src="assets/icons/services/service-pediatric-pharma.svg" alt="داروهای کودکان و اطفال" class="w-10 h-10 sm:w-12 sm:h-12 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <article class="service-showcase-card group">
          ...
          <div>
            ...
            <!-- Icon Frame -->
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gold-400/[0.04] border border-gold-400/20 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/50 group-hover:bg-gold-400/10 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.18)] transition-all duration-300">
              <img src="assets/icons/services/service-nutraceuticals.svg" alt="مکمل‌های غذایی و درمانی" class="w-10 h-10 sm:w-12 sm:h-12 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <article class="service-showcase-card group">
          ...
          <div>
            ...
            <!-- Icon Frame -->
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gold-400/[0.04] border border-gold-400/20 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/50 group-hover:bg-gold-400/10 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.18)] transition-all duration-300">
              <img src="assets/icons/services/service-biological-dressings.svg" alt="پانسمان‌های زیستی و سوختگی" class="w-10 h-10 sm:w-12 sm:h-12 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <article class="service-showcase-card group">
          ...
          <div>
            ...
            <!-- Icon Frame -->
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gold-400/[0.04] border border-gold-400/20 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/50 group-hover:bg-gold-400/10 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.18)] transition-all duration-300">
              <img src="assets/icons/services/service-plasma-therapy.svg" alt="داروهای مشتق از پلاسما و نوترکیب" class="w-10 h-10 sm:w-12 sm:h-12 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
        ...
        <article class="service-showcase-card group">
          ...
          <div>
            ...
            <!-- Icon Frame -->
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gold-400/[0.04] border border-gold-400/20 flex items-center justify-center p-3 mb-6 group-hover:border-gold-400/50 group-hover:bg-gold-400/10 group-hover:shadow-[0_0_25px_rgba(229,184,135,0.18)] transition-all duration-300">
              <img src="assets/icons/services/service-vaccine-adjuvants.svg" alt="یاورها و فرمولاسیون‌های اختصاصی واکسن" class="w-10 h-10 sm:w-12 sm:h-12 object-contain filter drop-shadow-[0_0_8px_rgba(229,184,135,0.25)] transition-transform duration-300 group-hover:scale-110">
            </div>
