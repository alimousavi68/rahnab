<?php
/**
 * Companies Portfolio Page Template
 * صفحه پرتفوی شرکت‌های تخصصی هلدینگ سرمایه‌گذاری رهناب فارمد
 */

$page_title  = 'شرکت‌های تخصصی | هلدینگ سرمایه‌گذاری رهناب فارمد';
$page_desc   = 'اکوسیستم شرکت‌های تخصصی رهناب فارمد: نوژین زیست فارمد، تأمین پلاسما نوژین، پرسیس ژن، آرک زیست آزما، پادرا سرم البرز و کارا یاخته تجهیز آزما.';
$is_home     = false;
      ...
      <div id="companyGrid" class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
        ...
        <article id="company-nojin" class="company-showcase-card group">
          ...
          <div>
            ...
            <div class="subsidiary-logo-frame mb-6 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center min-h-[95px] sm:min-h-[110px]">
              <img src="assets/images/subsidiaries/nojin_logo.webp" alt="نوژین زیست فارمد" class="subsidiary-mono-logo h-11 sm:h-14 w-auto object-contain">
            </div>
        ...
        <article id="company-tamin-plasma" class="company-showcase-card group">
          ...
          <div>
            <!-- Monochrome Logo Frame -->
            <div class="subsidiary-logo-frame mb-6 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center min-h-[95px] sm:min-h-[110px]">
              <img src="assets/images/subsidiaries/logo-tamin-plasma.svg" alt="تأمین پلاسما نوژین" class="subsidiary-mono-logo h-11 sm:h-14 w-auto object-contain">
            </div>
        ...
        <article id="company-persis" class="company-showcase-card group">
          ...
          <div>
            <!-- Monochrome Logo Frame -->
            <div class="subsidiary-logo-frame mb-6 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center min-h-[95px] sm:min-h-[110px]">
              <img src="assets/images/subsidiaries/logo-persisgen.png" alt="پرسیس‌ژن" class="subsidiary-mono-logo h-11 sm:h-14 w-auto object-contain">
            </div>
        ...
        <article id="company-arc" class="company-showcase-card group">
          ...
          <div>
            <!-- Monochrome Logo Frame -->
            <div class="subsidiary-logo-frame mb-6 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center min-h-[95px] sm:min-h-[110px]">
              <img src="assets/images/subsidiaries/logo-arc.png" alt="آرک زیست آزما" class="subsidiary-mono-logo h-11 sm:h-14 w-auto object-contain">
            </div>
        ...
        <article id="company-padra" class="company-showcase-card group">
          ...
          <div>
            <!-- Monochrome Logo Frame -->
            <div class="subsidiary-logo-frame mb-6 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center min-h-[95px] sm:min-h-[110px]">
              <img src="assets/images/subsidiaries/padra-serum-logo-who-Final-PNG-1.png" alt="پادرا سرم البرز" class="subsidiary-mono-logo h-11 sm:h-14 w-auto object-contain">
            </div>
        ...
        <article id="company-karayakhte" class="company-showcase-card group">
          ...
          <div>
            <!-- Monochrome Logo Frame -->
            <div class="subsidiary-logo-frame mb-6 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center min-h-[95px] sm:min-h-[110px]">
              <img src="assets/images/subsidiaries/logo-karayakhte.webp" alt="کارا یاخته تجهیز آزما" class="subsidiary-mono-logo h-11 sm:h-14 w-auto object-contain">
            </div>
